...
// import tinymce from 'tinymce/tinymce.jquery.js';

// System.import('./jquery/dist/jquery.min.js').then(
//   result => {const $ = result;}
// ).catch(
...
// System.import('tinymce/tinymce.jquery.js').then(mod => {
// 	window.tinymce = mod;
// });
...
export default {
  ...
  data(){
    return {
			// content: require('../html/content.html'),
      vueChange: false,
      testWatch: 'test1',
    }
  },
  ...
  // },
  beforeCreate() {
		console.log('beforeCreate "tinimce"');
	},
	created() {
		console.log('created "tinimce"');
		// this.init(); // вызов метода из массива methods
	},
	beforeMount(){
		console.log('beforeMount "tinimce"');
	},
	mounted(){
		console.log('mounted');
    ...
    var tinymceInit = /*tinymce.init*/({
      ...
      // convert_fonts_to_spans : false,
    	...
    	inline: true,
      // skin: false,
      plugins: ['paste', 'link', 'autoresize', 'save', 'code', 'table', 'image', 'visualblocks', 'textcolor','codesample'],
      ...
      beforeUpdate(){
    		console.log('beforeUpdate "tinimce"');
    	},
    	updated(){
    		console.log('updated "tinimce"');
    	},
    	activated(){
    		console.log('activated "tinimce"');
    	},
    	deactivated(){
    		console.log('deactivated "tinimce"');
    	},
    	beforeDestroy(){
    		console.log('beforeDestroy "tinimce"');
    	},
    	destroyed(){
    		console.log('destroyed "tinimce"');
    	},
